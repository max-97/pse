...
public class GroupTab {
    ...
    public boolean updateVM() {
        ...
        for (int i = 0; i < strategyTabs.size(); i++) {
            ...
            if ((relStrat && isSingleOrMultiplePercentage(distr)) || (!relStrat && isIntervalPlusSingleValues(distr))) {
        ...
        for (int i = 0; i < startCapitalTabs.size(); i++) {
            ...
            if (isSingleValue(capital) &&
                    ((relCapital && isSingleOrMultiplePercentage(distr)) || (!relCapital && isIntervalPlusSingleValues(distr)))) {
    ...
    private void $$$setupUI$$$() {
        ...
        distributionTextField.setToolTipText("<html> IDs: Intervalle von gültigen AgentIDs, Beispiele: '1, 1-10', '10 - 20, 25 - 30'  <br> Anteil: Prozentuale Anteile, Beispiele: '50', '100', '1'. <html>");
