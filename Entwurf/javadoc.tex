...
\subsubsection{Members inherited from class Observable }{
...
Ein Algorithmus der die Strategie eines Agenten einer Simulation anpasst, in Abhängigkeit von der Differenz der Ränge zweier verglichener Agenten. Ein Agent übernimmt die Strategie eines anderen mit einer Wahrscheinlichkeit δ*β, wobei δ die nichtnegative Differenz der Ränge ist und β eine Konstante, so dass 0 ≤ δ*β ≤ 1 gilt.\vskip .1in 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
{\bf  Parameters}
  \begin{itemize}
   \item{
\texttt{BETA} -- Konstante β, so dass 0 ≤ δ*β ≤ 1 gilt}
  \end{itemize}
}%end item
\end{itemize}
}%end item
...
Ein Algorithmus der die Strategie eines Agenten einer Simulation anpasst, in Abhängigkeit von der Differenz der Gesamtpunktzahlen zweier verglichener Agenten. Ein Agent übernimmt die Strategie eines anderen mit einer Wahrscheinlichkeit δ*β, wobei δ die nichtnegative Differenz der Gesamtpunktzahlen ist und β eine Konstante, so dass 0 ≤ δ*β ≤ 1 gilt.\vskip .1in 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\subsubsection{Members inherited from class Condition }{
...
\subsection{\label{de.sswis.model.conditions.Condition}Class Condition}{
...
\subsubsection{Members inherited from class BaseStrategy }{
...
\subsection{\label{de.sswis.model.strategies.BaseStrategy}Class BaseStrategy}{
...
\subsection{\label{de.sswis.model.strategies.Grim1}Class Grim1}{
...
\subsection{\label{de.sswis.model.strategies.Grim2}Class Grim2}{
...
\subsection{\label{de.sswis.model.strategies.TitForTat1}Class TitForTat1}{
...
\subsection{\label{de.sswis.model.strategies.TitForTat2}Class TitForTat2}{
...
\subsection{\label{de.sswis.view.AbstractManageCominedStartegiesView}Interface AbstractManageCominedStartegiesView}{
...
\vskip .1in
\vskip .1in
\subsection{\label{de.sswis.view.model.CombinedStrategy}Class CombinedStrategy}{
...
\subsection{\label{de.sswis.view.model.Configuration}Class Configuration}{
...
\subsection{\label{de.sswis.view.model.Game}Class Game}{
...
\subsection{\label{de.sswis.view.model.Group}Class Group}{
...
\subsection{\label{de.sswis.view.model.Initialization}Class Initialization}{
...
\subsection{\label{de.sswis.view.model.Result}Class Result}{
...
\subsection{\label{de.sswis.view.model.Strategy}Class Strategy}{
