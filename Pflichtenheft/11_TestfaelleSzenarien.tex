...
{Es öffnet sich die erste Seite des Assistenten.}

\item \testfall{Die erste oder zweiten Seite des Assistenten ist geöffnet.}
...
\item \testfall{Die erste oder zweiten Seite des Assistenten ist geöffnet.}
{Der Benutzer tätigt alle Eingaben auf dieser Seiter und bestätigt diese mit klicken auf 'weiter'.}
{Es wird die nächste Seite des Assistenten geöffnet.}

\item \testfall{Eine Seite des Assistenten ist geöffnet.}
{Der Benutzer tätigt alle Eingaben auf allen Seiten und bestätigt diese mit klicken auf 'fertig stellen'.}
{Es kommt eine Fehlermeldung zu einer fehlerhaften Eingabe.}
...
\item \testfall{Eine Seite des Assistenten ist geöffnet. Es wurden noch nicht alle Eingaben getätigt.}
{Der Benutzer klickt auf 'fertig stellen'.}
{Es kommt eine Fehlermeldung zu fehlenden Eingaben.}
\end{enumerate}
...
\item \testfall{Eine Seite des Assistenten zum erstellen einer Konfiguration ist geöffnet.}
